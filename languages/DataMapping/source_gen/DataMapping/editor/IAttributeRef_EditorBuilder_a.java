...
/*package*/ class IAttributeRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IAttributeRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_554e5y_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.entityRef$R3nz;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.entityRef$R3nz);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.entityRef$R3nz);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_554e5y_b0");
