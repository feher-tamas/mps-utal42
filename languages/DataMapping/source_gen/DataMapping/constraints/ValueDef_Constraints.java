...
public class ValueDef_Constraints extends BaseConstraintsDescriptor {
  public ValueDef_Constraints() {
    super(CONCEPTS.ValueDef$Mu);
  }
  ...
  public static class Name_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      ...
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:ca12430d-bb8b-4b60-b669-303893ccb47b(DataMapping.constraints)", "1931238374027369250"));
      }
      return result;
    }
